          ...
          <div style="display: flex; flex-direction: column; gap: 15px">
            ...
            <div class="form-group" style="margin: 0">
              ...
              <div style="display: flex; gap: 10px">
                <textarea
                  v-model="updateForm.diagnosis_result"
                  rows="2"
                ...
                ></textarea>
                <textarea
                  v-model="updateForm.actions_taken"
                  rows="2"
            ...
            <div class="form-group" style="margin: 0">
              ...
              <textarea
                v-model="updateForm.technician_notes"
                rows="2"
          ...
          >
            ...
            >
              <li
                v-for="h in history"
                :key="h.id"
                style="margin-bottom: 15px; padding-left: 15px; position: relative"
              >
                <span
                  style="
                    position: absolute;
                ...
                <div style="font-size: 0.75rem; color: #64748b; margin-bottom: 2px">
                  {{ new Date(h.created_at + 'Z').toLocaleString('id-ID') }}
                </div>
          ...
          <div style="display: flex; gap: 15px; margin-bottom: 15px">
            ...
            >
              ...
              <input
                ...
                style="display: none"
                accept="image/*"
                @change="(e) => handlePhotoUpload(e, 'Sebelum')"
              />
            </label>
            <label
              class="btn btn-secondary"
            ...
            >
              ...
              <input
                ...
                style="display: none"
                accept="image/*"
                @change="(e) => handlePhotoUpload(e, 'Sesudah')"
              />
            </label>
          </div>
      ...
      <div>
        ...
        <div class="card">
          ...
          >
            <span
              >Status:
              <strong :style="paymentStatusStyle(service.payment_status)">{{
