...
function registerServiceIpc() {
    electron_1.ipcMain.handle('get-services', (event, searchQuery, page, limit, technicianFilter) => serviceController.getServices(searchQuery, page, limit, technicianFilter));
