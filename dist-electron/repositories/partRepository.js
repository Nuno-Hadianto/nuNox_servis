...
function addPart(data) {
    return db_1.default.transaction(() => {
        const { part_code, name, category, buy_price, sell_price, unit } = data;
...
function updatePart(id, data) {
    return db_1.default.transaction(() => {
        ...
        db_1.default.drizzle.update(drizzleSchema_1.spareParts).set({
            part_code, name, category, buy_price, sell_price, unit, updated_at: (0, drizzle_orm_1.sql) `CURRENT_TIMESTAMP`
